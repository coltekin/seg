...
const char *gengetopt_args_info_help[] = {
  ...
  "  -M, --write-mode=filename     write model output to a file",
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->write_mode_arg = NULL;
  args_info->write_mode_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->write_mode_help = gengetopt_args_info_help[13] ;
  args_info->print_help = gengetopt_args_info_help[15] ;
  args_info->print_lb_help = gengetopt_args_info_help[16] ;
  args_info->print_ub_help = gengetopt_args_info_help[17] ;
  args_info->print_header_help = gengetopt_args_info_help[18] ;
  args_info->print_ph_help = gengetopt_args_info_help[19] ;
  args_info->print_unum_help = gengetopt_args_info_help[20] ;
  args_info->print_phng_help = gengetopt_args_info_help[21] ;
  args_info->print_ptp_help = gengetopt_args_info_help[22] ;
  args_info->print_ptp_min = 0;
  args_info->print_ptp_max = 0;
  args_info->print_wfreq_help = gengetopt_args_info_help[23] ;
  args_info->print_wfreq_sum_help = gengetopt_args_info_help[24] ;
  args_info->print_latex_help = gengetopt_args_info_help[25] ;
  args_info->print_prf_help = gengetopt_args_info_help[26] ;
  args_info->score_help = gengetopt_args_info_help[27] ;
  args_info->score_edges_help = gengetopt_args_info_help[28] ;
  args_info->alpha_help = gengetopt_args_info_help[30] ;
  args_info->pred_m_help = gengetopt_args_info_help[32] ;
  args_info->pred_m_min = 0;
  args_info->pred_m_max = 0;
  args_info->pred_norm_help = gengetopt_args_info_help[33] ;
  args_info->pred_xlen_help = gengetopt_args_info_help[34] ;
  args_info->pred_ylen_help = gengetopt_args_info_help[35] ;
  args_info->pred_xmax_help = gengetopt_args_info_help[36] ;
  args_info->pred_ymax_help = gengetopt_args_info_help[37] ;
  args_info->pred_xmin_help = gengetopt_args_info_help[38] ;
  args_info->pred_ymin_help = gengetopt_args_info_help[39] ;
  args_info->pred_printw_help = gengetopt_args_info_help[40] ;
  args_info->pred_printoptions_help = gengetopt_args_info_help[41] ;
  args_info->pred_swaplr_help = gengetopt_args_info_help[42] ;
  args_info->random_seed_help = gengetopt_args_info_help[44] ;
  args_info->random_rate_help = gengetopt_args_info_help[45] ;
  args_info->lexicon_partial_help = gengetopt_args_info_help[47] ;
  args_info->lex_nglen_help = gengetopt_args_info_help[48] ;
  args_info->lex_useprior_help = gengetopt_args_info_help[49] ;
  args_info->lex_minfreq_help = gengetopt_args_info_help[50] ;
  args_info->lex_minent_help = gengetopt_args_info_help[51] ;
  args_info->lex_mult_help = gengetopt_args_info_help[52] ;
  args_info->lex_wcombine_help = gengetopt_args_info_help[53] ;
  args_info->lex_norm_help = gengetopt_args_info_help[54] ;
  args_info->lex_help = gengetopt_args_info_help[55] ;
  args_info->lex_min = 0;
  args_info->lex_max = 0;
  args_info->lex_dir_help = gengetopt_args_info_help[56] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->write_mode_arg));
  free_string_field (&(args_info->write_mode_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->write_mode_given)
    write_into_file(outfile, "write-mode", args_info->write_mode_orig, 0);
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:d:o:I:O:M:pm:c:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'O':	/* output lexicon file.  */
          ...
          break;
        case 'M':	/* write model output to a file.  */
        
        
          if (update_arg( (void *)&(args_info->write_mode_arg), 
               &(args_info->write_mode_orig), &(args_info->write_mode_given),
              &(local_args_info.write_mode_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "write-mode", 'M',
              additional_error))
            goto failure;

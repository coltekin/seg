...
const char *gengetopt_args_info_help[] = {
  ...
  "      --ipa                     The input contains UTF-8 encoded IPA symbols\n                                  (default=off)",
  "      --syl[=delimeter]         The input contains syllable boundary markers\n                                  (default=`.')",
  "      --stress=filename         filename to read stress patterns from",
  ...
  "\nOptions for printing segmentation measures:",
  ...
  "      --print-unum              print the utterance number  (default=off)",
...
const char *cmdline_parser_method_values[] = {"lexicon", "lm", "random", "lexc", "nv", "combine", 0}; /*< Possible values for method. */
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->ipa_given = 0 ;
  args_info->syl_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->ipa_flag = 0;
  args_info->syl_arg = gengetopt_strdup (".");
  args_info->syl_orig = NULL;
  args_info->stress_arg = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->ipa_help = gengetopt_args_info_help[3] ;
  args_info->syl_help = gengetopt_args_info_help[4] ;
  args_info->stress_help = gengetopt_args_info_help[5] ;
  args_info->debug_help = gengetopt_args_info_help[6] ;
  args_info->quiet_help = gengetopt_args_info_help[7] ;
  args_info->progress_help = gengetopt_args_info_help[8] ;
  ...
  args_info->print_unum_help = gengetopt_args_info_help[19] ;
  args_info->print_phng_help = gengetopt_args_info_help[20] ;
  args_info->print_ptp_help = gengetopt_args_info_help[21] ;
  args_info->print_ptp_min = 0;
  args_info->print_ptp_max = 0;
  args_info->print_wfreq_help = gengetopt_args_info_help[22] ;
  args_info->print_wfreq_sum_help = gengetopt_args_info_help[23] ;
  args_info->print_latex_help = gengetopt_args_info_help[24] ;
  args_info->print_prf_help = gengetopt_args_info_help[25] ;
  args_info->score_help = gengetopt_args_info_help[26] ;
  args_info->score_edges_help = gengetopt_args_info_help[27] ;
  args_info->alpha_help = gengetopt_args_info_help[29] ;
  args_info->pred_m_help = gengetopt_args_info_help[31] ;
  args_info->pred_m_min = 0;
  args_info->pred_m_max = 0;
  args_info->pred_norm_help = gengetopt_args_info_help[32] ;
  args_info->pred_xlen_help = gengetopt_args_info_help[33] ;
  args_info->pred_ylen_help = gengetopt_args_info_help[34] ;
  args_info->pred_xmax_help = gengetopt_args_info_help[35] ;
  args_info->pred_ymax_help = gengetopt_args_info_help[36] ;
  args_info->pred_xmin_help = gengetopt_args_info_help[37] ;
  args_info->pred_ymin_help = gengetopt_args_info_help[38] ;
  args_info->pred_printw_help = gengetopt_args_info_help[39] ;
  args_info->pred_printoptions_help = gengetopt_args_info_help[40] ;
  args_info->pred_swaplr_help = gengetopt_args_info_help[41] ;
  args_info->random_seed_help = gengetopt_args_info_help[43] ;
  args_info->random_rate_help = gengetopt_args_info_help[44] ;
  args_info->lexicon_partial_help = gengetopt_args_info_help[46] ;
  args_info->lex_nglen_help = gengetopt_args_info_help[47] ;
  args_info->lex_useprior_help = gengetopt_args_info_help[48] ;
  args_info->lex_minfreq_help = gengetopt_args_info_help[49] ;
  args_info->lex_minent_help = gengetopt_args_info_help[50] ;
  args_info->lex_mult_help = gengetopt_args_info_help[51] ;
  args_info->lex_wcombine_help = gengetopt_args_info_help[52] ;
  args_info->lex_norm_help = gengetopt_args_info_help[53] ;
  args_info->lex_help = gengetopt_args_info_help[54] ;
  args_info->lex_min = 0;
  args_info->lex_max = 0;
  args_info->lex_dir_help = gengetopt_args_info_help[55] ;
  args_info->ub_nglen_help = gengetopt_args_info_help[57] ;
  args_info->ub_ngmin_help = gengetopt_args_info_help[58] ;
  args_info->ub_ngmax_help = gengetopt_args_info_help[59] ;
  args_info->ub_lmin_help = gengetopt_args_info_help[60] ;
  args_info->ub_lmax_help = gengetopt_args_info_help[61] ;
  args_info->ub_rmin_help = gengetopt_args_info_help[62] ;
  args_info->ub_rmax_help = gengetopt_args_info_help[63] ;
  args_info->ub_type_help = gengetopt_args_info_help[64] ;
  args_info->sub_ngmin_help = gengetopt_args_info_help[65] ;
  args_info->sub_ngmax_help = gengetopt_args_info_help[66] ;
  args_info->method_help = gengetopt_args_info_help[68] ;
  args_info->cues_help = gengetopt_args_info_help[69] ;
  args_info->cues_min = 0;
  args_info->cues_max = 0;
  args_info->cue_source_help = gengetopt_args_info_help[70] ;
  args_info->psb_cheat_help = gengetopt_args_info_help[71] ;
  args_info->pred_source_help = gengetopt_args_info_help[72] ;
  args_info->phon_source_help = gengetopt_args_info_help[73] ;
  args_info->stress_source_help = gengetopt_args_info_help[74] ;
  args_info->lex_source_help = gengetopt_args_info_help[75] ;
  args_info->combine_help = gengetopt_args_info_help[76] ;
  args_info->combine_rate_help = gengetopt_args_info_help[77] ;
  args_info->boundary_method_help = gengetopt_args_info_help[78] ;
  args_info->peak_help = gengetopt_args_info_help[79] ;
  args_info->threshold_help = gengetopt_args_info_help[80] ;
  args_info->norm_help = gengetopt_args_info_help[81] ;
  args_info->vote_help = gengetopt_args_info_help[82] ;
  args_info->prior_data_help = gengetopt_args_info_help[83] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->syl_arg));
  free_string_field (&(args_info->syl_orig));
  free_string_field (&(args_info->stress_arg));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->ipa_given)
    write_into_file(outfile, "ipa", 0, 0 );
  if (args_info->syl_given)
    write_into_file(outfile, "syl", args_info->syl_orig, 0);
  if (args_info->stress_given)
    write_into_file(outfile, "stress", args_info->stress_orig, 0);
  ...
  if (args_info->print_unum_given)
    write_into_file(outfile, "print-unum", 0, 0 );
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:d:o:I:O:pm:c:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          /* The input contains UTF-8 encoded IPA symbols.  */
          if (strcmp (long_options[option_index].name, "ipa") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->ipa_flag), 0, &(args_info->ipa_given),
                &(local_args_info.ipa_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "ipa", '-',
                additional_error))
              goto failure;
          
          }
          /* The input contains syllable boundary markers.  */
          else if (strcmp (long_options[option_index].name, "syl") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->syl_arg), 
                 &(args_info->syl_orig), &(args_info->syl_given),
                &(local_args_info.syl_given), optarg, 0, ".", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "syl", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "stress") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->stress_arg), 
                ...
                &(local_args_info.stress_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "stress", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "shuffle") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->shuffle_arg), 
                ...
                &(local_args_info.shuffle_given), optarg, 0, "0", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "shuffle", '-',
                additional_error))
              goto failure;
          ...
          /* print the utterance number.  */
          else if (strcmp (long_options[option_index].name, "print-unum") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->print_unum_flag), 0, &(args_info->print_unum_given),
                &(local_args_info.print_unum_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "print-unum", '-',
                additional_error))
              goto failure;

...
struct gengetopt_args_info
{
  ...
  int ipa_flag;	/**< @brief The input contains UTF-8 encoded IPA symbols (default=off).  */
  const char *ipa_help; /**< @brief The input contains UTF-8 encoded IPA symbols help description.  */
